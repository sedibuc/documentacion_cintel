#!/usr/bin/env python3
"""Write updated cronograma.md for poc-die."""
import os

BASE = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))
TARGET = os.path.join(BASE, "poc-die", "content", "cronograma.md")

CONTENT = r"""# Cronograma de trabajo — Sprints semanales Jun 9–30
...
| Jun 13 (Vie) | ValidationEngine (campos obligatorios, tipos de dato). Extensión a `DOC_ESCRITURA` (schema + prompt v1). Ajuste de prompts con base en primeros resultados. | — | Extractor para ambos tipos; prompts ajustados |

**Hito 1 (fin Sprint 1 — Jun 13):** extractor LLM operativo para `DOC_CTL` y `DOC_ESCRITURA`. CU-01 y CU-02 completados.
...
**Hito 2 (fin Sprint 2 — Jun 20):** CrossValidator con módulo admin, alertas operativas, métricas de calidad con corpus real. CU-03 a CU-07 completados.
...
| StructuredExtractor (LLM + schemas + prompts CTL/Escritura) | 2.5 | Sprint 1 |
