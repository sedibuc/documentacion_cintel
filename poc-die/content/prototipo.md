# Prototipo de la PoC — API, contratos, módulo administrativo y mockup navegable
...
│   │   └── audit.py              # AuditLog
│   ├── services/
│   │   ├── content_extraction.py # ContentExtractionService (PDF base64 → LLM directo, sin detección previa)
...
7. **Trazabilidad** (3 min): mostrar audit log de todas las ejecuciones.
