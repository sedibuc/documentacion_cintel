...
<span class="badge">Disponibilidad máxima: 20 h</span>
...
| Concepto | Valor |
|---|---|
| Tiempo total disponible | 20 h |
| Bloque 1 — Validación rápida de propuestas pre-resueltas (8 ítems) | 6 h |
| Bloque 2 — Análisis especializado de preguntas abiertas (5 preguntas) | 13 h |
| Margen de seguridad | 1 h |
...
El equipo propone un baseline técnico para cada ítem. El experto revisa y responde: **Sí / No / Ajustar**. El tiempo estimado cubre lectura, evaluación y comentario, no investigación.
...
**Tiempo estimado de revisión**: 0,75 h
...
**Tiempo estimado de revisión**: 1 h
...
**Tiempo estimado de revisión**: 0,5 h
...
**Tiempo estimado de análisis**: 3 h
...
**Tiempo estimado de análisis**: 2 h
...
| Bloque | Ítem | Descripción | Tiempo |
|---|---|---|---|
| B1 | B1-1 | Motor OCR y política de aceptación | 0,75 h |
| B1 | B1-2 | Arquitectura base NER supervisado | 1 h |
| B1 | B1-3 | Formato de anotación y herramienta | 0,75 h |
| B1 | B1-4 | Segmentación documental | 0,75 h |
| B1 | B1-5 | Score de confianza y fallback | 0,75 h |
| B1 | B1-6 | Normalización de entidades | 0,5 h |
| B1 | B1-7 | Versionado de modelos | 0,5 h |
| B1 | B1-8 | Instrumentación del pipeline | 0,5 h |
| | | **Subtotal Bloque 1** | **6 h** |
| B2 | A1 | Layout-aware vs. NER textual puro | 3 h |
| B2 | A2 | Tamaño mínimo del corpus | 2 h |
| B2 | A3 | Umbrales F1 para BETA y PRODUCCIÓN | 2 h |
| B2 | A4 | Señales de degradación en producción real | 3 h |
| B2 | A5 | Escala límite de CPU y costo OCR cloud | 3 h |
| | | **Subtotal Bloque 2** | **13 h** |
| | | **Total estimado** | **19 h** |
